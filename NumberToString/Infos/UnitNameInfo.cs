...
public static class UnitNameInfo {
    ...
    /// </summary>
    /// <param name="scale">Индекс класса, где 0 - единицы, 1 - тысячи.</param>
    ...
    public static string GetNumberScaleName(int scale, int scaleNameForm, Cases @case) {
        ...
        if (@case is Cases.Nominative or Cases.Accusative && scaleNameForm >= 1) {
